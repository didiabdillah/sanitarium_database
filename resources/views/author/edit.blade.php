...
<div class="container-fluid">
    ...
    <div class="row clearfix">
        <div class="card">
            ...
            <div class="body">
                <form id="form_validation" method="POST" method="{{route('author_update', $author->author_id)}}" enctype="multipart/form-data">
                    @csrf
                    @method('patch')
                    <div class="form-group form-float">
                        <div class="form-line @error('label'){{'error focused'}}@enderror">
                            <input type="text" class="form-control" name="label" value="{{$author->author_label}}">
                    ...
                    <div class="form-group form-float">
                        <div class="form-line @error('link'){{'error focused'}}@enderror">
                            <input type="text" class="form-control" name="link" value="{{$author->author_link}}">
