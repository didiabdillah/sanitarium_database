...
<div class="container-fluid">
    ...
    <div class="row clearfix">
        <a href="{{route('author_create')}}" class="btn btn-primary btn-lg waves-effect">
                    ...
                    <table class="table table-bordered table-striped table-hover js-basic-example dataTable">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>{{($row->author_link) ? $row->author_link : "-" }}</td>

                                <td>
                                    <form action="{{route('author_destroy', $row->author_id)}}" method="post">
                                        @csrf
                                        @method('delete')

                                        <a href="{{route('author_edit', $row->author_id)}}" class="btn bg-blue btn-circle waves-effect waves-circle waves-float">
