...
<div class="container-fluid">
    ...
    <div class="row clearfix">
        <a href="{{route('category_create')}}" class="btn btn-primary btn-lg waves-effect">
                    ...
                    <table class="table table-bordered table-striped table-hover js-basic-example dataTable">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <form action="{{route('category_destroy', $row->category_id)}}" method="post">
                                        @csrf
                                        @method('delete')

                                        <a href="{{route('category_edit', $row->category_id)}}" class="btn bg-blue btn-circle waves-effect waves-circle waves-float">
