                ...
                <form id="form_validation" method="POST" method="{{route('resource_store')}}" enctype="multipart/form-data">
                    ...
                    <div class="form-group form-float">
                        ...
                        <select class="form-control show-tick @error('category'){{'error focused'}}@enderror" data-live-search="true" name="category">
                            ...
                            <option value="{{$row->category_id}}" @if(old('category')==$row->category_id){{'selected'}}@endif>{{$row->category_label}}</option>
                            @endforeach
                        </select>
                        @error('category')
                    ...
                    <div class="form-group form-float">
                        ...
                        <select class="form-control show-tick @error('sub_category'){{'error focused'}}@enderror" data-live-search="true" name="sub_category">
                            ...
                            <option value="{{$row->sub_category_id}}" @if(old('sub_category')==$row->sub_category_id){{'selected'}}@endif>{{$row->sub_category_label}}</option>
                            @endforeach
                        </select>
                        @error('sub_category')
